...
export default function Controls() {
  ...
  return (
    <div className="w-full text-white flex flex-row justify-center items-center z-[80]">
      <button
        onClick={water}
        className="bg-[#43E0FF] mr-2 text-black font-bold py-4 px-2 rounded-[12px]"
      >
        <Image
          src="/waterdrop-icon.svg"
          alt="Water"
          className="h-[25px] filter fill-white"
          width={50}
          height={50}
          priority
        />
      ...
      <button
        onClick={play}
        className="bg-[#FF0080] ml-2 text-black font-bold py-4 px-2 rounded-[12px]"
      >
        <Image
          src="/play.svg"
          alt="Play"
